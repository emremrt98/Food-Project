                ...
                <div className='py-4 pr-4'>
                    ...
                    <div className='mt-2'>
                        ...
                        <div className='mt-2 flex gap-1 items-center'>
                            <LuSquarePen size={16} className='text-primary' />
                            <span className='text-primary text-sm '>Emre Mert</span>
                        </div>
                        <p className='mt-2 text-secondary text-sm font-normal'>{description}</p>
                    </div>
